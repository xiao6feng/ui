...
class ObPopupMenuButton<T> extends StatelessWidget {
  const ObPopupMenuButton({
    Key? key,
  ...
  Widget build(BuildContext context) {
    final PopupMenuButtonTheme? theme =
        Theme.of(context).extension<AppTheme>()?.popupMenuButtonTheme;
    ...
    return PopupMenuButton(
      ...
      surfaceTintColor: surfaceTintColor ?? theme?.surfaceTintColor,
      padding: padding ?? theme?.padding ?? EdgeInsets.all(8),
      child: child,
