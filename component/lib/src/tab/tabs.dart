...
import 'package:theme/theme.dart' hide IconTheme;
...
class _TabStyle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    final TabBarTheme tabBarTheme =
        Theme.of(context).extension<AppTheme>()!.tabBarTheme;

    final Animation<double> animation = listenable as Animation<double>;

    final iconSize = tabBarTheme.iconSize;
    final TextStyle defaultStyle = (labelStyle ?? tabBarTheme.labelStyle);
    ...
    final Color selectedColor = labelColor ?? tabBarTheme.labelColor;
