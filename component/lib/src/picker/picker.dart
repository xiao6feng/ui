...
import 'address_picker/address_result.dart';
import 'date_picker/ob_date_picker.dart';
import 'date_range_picker/ob_date_range_picker.dart';
import 'date_range_picker/time_range.dart';
import 'ob_picker/ob_picker.dart';
            ...
            child: Builder(
              builder: (BuildContext context) {
                return _Picker<T>(
                  route: this,
                  backgroundColor:
                      theme?.backgroundColor ?? _pickerBackgroundColor,
                  elevation: 0,
                  shape: theme?.shape ?? _pickerShape,
                  clipBehavior: clipBehavior,
                  enableDrag: enableDrag,
                  maxPickerHeight:
                      maxPickerHeight ?? theme?.maxPickerHeight ?? 340,
                );
              },
            ),
          );
...
Future<TimeRange?> showObDateRangePicker({
  ...
  return Navigator.of(context).push<TimeRange>(
    _PickerRoute<TimeRange>(
        ...
        maxPickerHeight: maxPickerHeight ?? 390),
  );
}
