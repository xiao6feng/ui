...
class TransformInfo {
  ...
  ///  The widget in the center of the screen' which is  full visible, position is 0.
  ///  The widge in the left ,may be hidden, of the screen's position is less than 0, -1 when out of the screen.
  ///  The widge in the right ,may be hidden, of the screen's position is greater than 0,  1 when out of the screen
  ///
  ///
...
class TransformerPageController extends PageController {
  ...
  static int _getRealIndexFromRenderIndex(
    ...
    var result = reverse ? (itemCount - index - 1) : index;
    if (loop) {
      result += kMiddleValue;
    }
    return result;
  ...
  Widget _buildItem(BuildContext context, int index) {
    return AnimatedBuilder(
      ...
      builder: (BuildContext c, Widget? w) {
        ...
        final page = _pageController.realPage ?? 0;
